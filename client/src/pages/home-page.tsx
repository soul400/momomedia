          ...
          <main className="p-6">
            ...
            <section className="mb-10">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold font-heading">أبرز التصاميم</h2>
                <Link href="/featured">
            ...
            <section className="mb-10">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold font-heading">داعمين المهره للشهر الحالي</h2>
    ...
    <section className="mb-10">
      <div className="relative rounded-xl overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 p-6 z-20">
          ...
          <p className="text-gray-200 mb-4">أرشيف تصاميم ولحظات بث المهره الإبداعية</p>
